...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<activerecord>.freeze, [">= 6.0.0", "< 7.3"])
    s.add_runtime_dependency(%q<railties>.freeze, [">= 6.0.0", "< 7.3"])
    s.add_runtime_dependency(%q<nokogiri>.freeze, ["~> 1.14"])
  else
    s.add_dependency(%q<rake>.freeze, [">= 10.0"])
    s.add_dependency(%q<activerecord>.freeze, [">= 6.0.0", "< 7.3"])
    s.add_dependency(%q<railties>.freeze, [">= 6.0.0", "< 7.3"])
